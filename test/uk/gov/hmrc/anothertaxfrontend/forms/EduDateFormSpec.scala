...
class EduDateFormSpec extends UnitSpec {
  val form: Form[EduDateData] = EduDateForm.form

  "EduDateForm.form" when {
    ...
    "date is in the future" must {
      "result in a an error" in {
        ...
        error.message mustBe "form.error.edu.date.future"
      }
    }
    ...
    "year is before 1850" must {
      "result in a an error against the year field" in {
        ...
        val error = result("year").error.getOrElse(fail("error against year field not generated"))
        error.message mustBe "form.error.edu.year.low"
      }
    }
    ...
    "day is not in month" must {
      "result in a an error against the entire form" in {
        ...
        val error = result("").error.getOrElse(fail("error against form not generated"))
        error.message mustBe "form.error.edu.date.day"
      }
    }
    ...
    "day is below 1" must {
      "result in a an error against the day field" in {
        ...
        val error = result("day").error.getOrElse(fail("error against day field not generated"))
        error.message mustBe "form.error.edu.day.low"
      }
    }
    ...
    "month is below 1" must {
      "result in a an error against the month field" in {
        ...
        val error = result("month").error.getOrElse(fail("error against month field not generated"))
        error.message mustBe "form.error.edu.month.low"
      }
    }
    ...
    "day is above 31" must {
      "result in a an error against the month field" in {
        ...
        val error = result("day").error.getOrElse(fail("error against day field not generated"))
        error.message mustBe "form.error.edu.day.high"
      }
    }
    ...
    "month is above 12" must {
      "result in a an error against the month field" in {
        ...
        val error = result("month").error.getOrElse(fail("error against month field not generated"))
        error.message mustBe "form.error.edu.month.high"
      }
    }
    ...
    "day blank" must {
      "result in a an error against the day field" in {
        ...
        val error = result("day").error.getOrElse(fail("error against day field not generated"))
        error.message mustBe "form.error.edu.day.blank"
      }
    }
    ...
    "month blank" must {
      "result in a an error against the month field" in {
        ...
        val error = result("month").error.getOrElse(fail("error against month field not generated"))
        error.message mustBe "form.error.edu.month.blank"
      }
    }
    ...
    "year blank" must {
      "result in a an error against the year field" in {
        ...
        val error = result("year").error.getOrElse(fail("error against year field not generated"))
        error.message mustBe "form.error.edu.year.blank"
      }
    }
    ...
    "day not number" must {
      "result in a an error against the day field" in {
        ...
        val error = result("day").error.getOrElse(fail("error against day field not generated"))
        error.message mustBe "form.error.edu.day.char"
      }
    }
    ...
    "month not number" must {
      "result in a an error against the month field" in {
        ...
        val error = result("month").error.getOrElse(fail("error against month field not generated"))
        error.message mustBe "form.error.edu.month.char"
      }
    }
    ...
    "year not number" must {
      "result in a an error against the year field" in {
        ...
        val error = result("year").error.getOrElse(fail("error against year field not generated"))
        error.message mustBe "form.error.edu.year.char"
      }
    }
    ...
    "year more than 4 characters" must {
      "result in a an error against the year field" in {
        ...
        val error = result("year").error.getOrElse(fail("error against year field not generated"))
        error.message mustBe "form.error.edu.year.length"
      }
    }

    "bound with data containing a valid date" must {

      val model = EduDateData(19, 3, 2000)
